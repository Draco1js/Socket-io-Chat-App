...
function onload() {
	...
	accessPort.classList.remove("hidden")

	const main = document.getElementById("ChatStuff")

	socket.on("join", function(room) {
		main.classList.remove("hidden");
		accessPort.classList.add("hidden");
...
function Connect() {
	const main = document.getElementById("AccessPort");
